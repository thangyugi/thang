...
import IntroButtonStyle from './IntroButton.module.scss'
import Link from 'next/link'

const IntroButton = () => {
  const classes = classNames(
    [IntroButtonStyle['button']],
    [IntroButtonStyle['button--surtur']]
  )
  return (
    <Link href='/personal-space'>
      <button className={classes}>
        <svg
          className={IntroButtonStyle['textcircle']}
          viewBox='0 0 500 500'
          xmlns='http://www.w3.org/2000/svg'
          xmlnsXlink='http://www.w3.org/1999/xlink'
        >
          <title>Read more about me &amp; my story</title>
          <defs>
            <path
              id='textcircle'
          ...
          <text>
            <textPath
              ...
              aria-label='Read more about me &amp; my story'
              textLength='900'
            >
        ...
        <svg
          aria-hidden='true'
          className={IntroButtonStyle['finger']}
          width='70'
          height='70'
          viewBox='0 0 70 70'
          xmlns='http://www.w3.org/2000/svg'
        >
          <svg
            ...
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
            className={IntroButtonStyle['finger__inner']}
          >
